...
const SectionFour = () => {
  ...
  return (
    <motion.section ref={refFour} className="flex flex-col w-full relative">
        <div className="w-full h-[70vh] overflow-hidden mb-5">
            <motion.img
                src={client1}
                className="w-[100%]"
                initial={{ y: -600 }}
        ...
        <div className="w-full flex flex-col mt-[5%]">
            <h1 className="w-[70%] mx-auto flex justify-center items-center bg-slate-500 p-5 text-white text-[1rem] md:text-[1.5rem] h-[10vh] mt-[10%] rounded-lg">
