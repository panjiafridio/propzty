    ...
    <div>
        <section className="flex flex-col relative w-full mt-[5%]">
            ...
            <div className="flex flex-col md:flex-row w-full">
                ...
                <div className="w-[100%] p-4 font-normal flex items-center md:text-[22px] lg:text-[1.7rem] text-[1rem] leading-[1.22] font-Inter text-white bg-[rgb(52,62,81)]">
            ...
            >
                <div
                className="p-4 font-normal text-[1rem] md:text-[22px] lg:text-[1.7rem] leading-[1.22] font-Inter text-white bg-[rgb(52,62,81)] w-[100%] flex items-center">{`Behold the power of data! Over just three short years, Bali's rental property market has undergone a jaw-dropping transformation. It's a tale of resilience, from pandemic-induced revenue declines to an awe-inspiring exponential growth phase. The Bali property market is on the move, and the time to seize this dynamic opportunity is now!`}
                </div>
