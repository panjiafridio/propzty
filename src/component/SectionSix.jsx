  ...
  return (
    <div>
        <section className="flex flex-col relative w-full mt-[5%]">
            ...
            <h1 className="font-semibold text-[50px] leading-[1.22] font-Inter text-[#212121] p-5">
                Market Analysis
            </h1>
            ...
            <div className="flex flex-col md:flex-row w-full">
                ...
                <div className="w-[100%] p-4 font-normal text-[22px] leading-[1.22] font-Inter text-white bg-[rgb(52,62,81)]">
